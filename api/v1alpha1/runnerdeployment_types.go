...
type RunnerDeploymentSpec struct {
	...
	// foo is an example field of RunnerDeployment. Edit runnerdeployment_types.go to remove/update
	// +optional
...
type RunnerDeploymentStatus struct {
	...
	// conditions represent the current state of the RunnerDeployment resource.
...
type RunnerDeployment struct {
	...
	// spec defines the desired state of RunnerDeployment
	// +required
	Spec RunnerDeploymentSpec `json:"spec"`

	// status defines the observed state of RunnerDeployment
	// +optional
	Status RunnerDeploymentStatus `json:"status,omitzero"`
}
